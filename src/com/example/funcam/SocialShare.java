...
public class SocialShare extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		tvHint = (TextView) findViewById(R.id.tvSocialHint);
	...
	private final class ResponseListener implements DialogListener {
		...
		public void onComplete(Bundle values) {
			...
			Toast.makeText(SocialShare.this, providerName + " connected", Toast.LENGTH_LONG).show();
	...
	private final class MessageListener implements SocialAuthListener<Integer> {
		...
		public void onExecute(String provider, Integer t) {
			...
			if (status.intValue() == 200 || status.intValue() == 201 || status.intValue() == 204)
				Toast.makeText(SocialShare.this, "Message posted on " + provider, Toast.LENGTH_LONG).show();
			else
				Toast.makeText(SocialShare.this, "Message not posted on " + provider, Toast.LENGTH_LONG).show();
		}

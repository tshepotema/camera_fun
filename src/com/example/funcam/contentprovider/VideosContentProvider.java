package com.example.funcam.contentprovider;

import java.util.Arrays;
import java.util.HashSet;

import com.example.funcam.database.FuncamDatabaseHelper;
import com.example.funcam.database.VideosTable;
...
public class VideosContentProvider extends ContentProvider {
	...
	private FuncamDatabaseHelper database;
	
	//used for the URI match
	private static final int VIDEOS = 10;
	private static final int VIDEO_ID = 20;
	private static final String AUTHORITY = "com.example.funcam.contentprovider";
	...
	public boolean onCreate() {
		database = new FuncamDatabaseHelper(getContext());
		return false;
	}

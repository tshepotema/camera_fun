...
public class CustomListMyPhotos extends ArrayAdapter<String> {
	...
	public CustomListMyPhotos(Activity context, ArrayList<String> webPhotoID2, ArrayList<String> photoUploader2, ArrayList<String> photoDescription2
			, ArrayList<String> photoURL2, ArrayList<String> photoLat2, ArrayList<String> photoLon2,  ArrayList<String> photoDate2) {
		super(context, R.layout.myphoto_list_row, webPhotoID2);
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		View rowView = inflater.inflate(R.layout.myphoto_list_row, null, true);
